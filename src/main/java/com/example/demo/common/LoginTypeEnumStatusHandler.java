...
public class LoginTypeEnumStatusHandler extends BaseTypeHandler<LoginTypeEnum> {
    private Class<LoginTypeEnum> type;

    private final LoginTypeEnum[] enums;
     ...
     */
    public LoginTypeEnumStatusHandler(Class<LoginTypeEnum> type) {
        if (type == null)
     ...
     * @return code对应的枚举类
     */
    private LoginTypeEnum locateEnumStatus(int code) {
        for (LoginTypeEnum c : enums) {
