...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: #f2f2f2 url("${request.contextPath}/images/blueprint.png") repeat 0 0;
        }
        ...
        div.da-error-wrapper .da-error-code {
            ...
            font-size: 32px;
            text-align: center;
            background: url("${request.contextPath}/images/error-hanger.png") no-repeat center center;
        ...
        div.da-error-wrapper .da-error-pin {
            ...
            z-index: 10;
            position: relative;
            background: url("${request.contextPath}/images/error-pin.png") no-repeat center center
        }
